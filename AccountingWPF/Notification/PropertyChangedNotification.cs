...
namespace AccountingWPF.Notification
{
    public abstract class PropertyChangedNotification : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        protected virtual void NotifyPropertyChanged(string propertyName)
        {
            ...
            //dali je potrebna nova varijabla? jel moze ako koristis ProprtyChanged?
        ...
        protected virtual void NotifyPropertyChanged<T>(Expression<Func<T>> propertySelector)
        {
        ...
        protected virtual string GetPropertyName(LambdaExpression expression)
        {
